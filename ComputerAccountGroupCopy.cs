...
namespace ComputerAccountGroupCopy
{
    class CAGCMain
    {
        struct CMDArguments
        ...
        {
            Console.WriteLine("Parameters must be specified to run ComputerAccountGroupCopy.");
            Console.WriteLine("Run ComputerAccountGroupCopy -? to get the parameter syntax.");
        }
        ...
        static void funcPrintParameterSyntax()
        {
            ...
            Console.WriteLine("-dest:[ComputerName]              specify destination computer");
            Console.WriteLine();
            Console.WriteLine("Examples:");
            Console.WriteLine("ComputerAccountGroupCopy -run -ref:COMPUTER1 -dest:COMPUTER2");
        }
                    ...
                    if (cmdargs[1].Contains("-ref:"))
                    {
                        ...
                        if (bCmdArg1Complete & cmdargs.Length > 2)
                        {
                            if (cmdargs[2].Contains("-dest:"))
                            {
                                ...
                                objCMDArguments.strCheckComputer = cmdargs[2].Substring(6);
        ...
        static void funcProgramExecution(CMDArguments objCMDArguments2)
        {
            try
            {
                // LogToEventLog("ComputerAccountGroupCopy", "ComputerAccountGroupCopy started successfully.", 1401);

                funcProgramRegistryTag("ComputerAccountGroupCopy");
                ...
                strSourceAccount = objCMDArguments2.strReferenceComputer;
                strDestinationAccount = objCMDArguments2.strCheckComputer;
        ...
        static void funcWriteToErrorLog(string strErrorMessage)
        {
            try
            {
                FileStream newFileStream = new FileStream("Err-ComputerAccountGroupCopy.log", FileMode.Append, FileAccess.Write);
